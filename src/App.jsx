// App.jsx - 최종본: 다크모드 자동 감지 + 하단 탭 네비게이션 + 모바일 최적화
...
function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-[#111] border-t shadow-md flex justify-around items-center h-14 text-xs sm:text-sm">
